...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        if(checkIfArgsFormatIsValid(args) && args.length == 81) {
            ...
            positions = Stream.of(SudokuGenerator.generateSudokuInputs(15))
                    .collect(toMap(
                            k -> k.split(";")[0],
                            v -> v.split(";")[1]
                    ));
    ...
    private static void inputNumber() {
        ...
        var col = runUntiletValidNumber(0, 8);
        System.out.println("Informe a linha em que o número será inserido: ");
        var row = runUntiletValidNumber(0, 8);
        System.out.printf("Informe o número que vai entrar na posição [%s,%s]\n", col, row);
        var value = runUntiletValidNumber(1, 9);
    ...
    private static void showGameStatus() {
        ...
        if(board.hasErrors()) {
            System.out.println("O jogo contén erros");
        } else {
    ...
    private static void clearGame() {
        ...
        while (!confirm.equalsIgnoreCase("sim") && !confirm.equalsIgnoreCase("não")) {
            System.out.println("Informe 'sim' sou 'não'");
        }
    ...
    private static int  runUntiletValidNumber(final int min, final int max) {
